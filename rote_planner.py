...
const MX_CHAIN = [
  ...
  {id:'tatooine',name:'Tatooine', align:'mx',zone:3,cms:3,fleets:1,sms:2,smLabel:'Unlock Mandalore Special Mission',smThreshold:25,smUnlocks:'mandalore', cmPts:341250, fleetPts:682500, opsVal:13200000, stars:[190953125,305525000,407366667]},
  ...
  {id:'hoth',    name:'Hoth',     align:'mx',zone:6,cms:3,fleets:1,sms:1,smLabel:'Special Mission',                  cmPts:1151719, fleetPts:2303438, opsVal:86486400, stars:[582632425,1059331682,1246272567]},
];
const LS_CHAIN = [
...
const BONUS_PLANETS = [
  ...
  {id:'zeffo',    name:'Zeffo',    align:'bonus',zone:3,cms:3,fleets:1,sms:1,smLabel:'Clone Trooper Special Mission', cmPts:341250,  fleetPts:682500,  opsVal:13200000, stars:[143589583,229743333,287179167],unlockedBy:'bracca',unlockedAt:30},
];
...
const ROTE_MISSIONS = {
  ...
  mustafar: { zone:1, minRelic:5, cms:[
    {name:'Bottom-Left',         align:'ds', topTeams:['Inquisitorius','First Order','Sith','Dark Side GL']},
    {name:'Top',                 align:'ds', topTeams:['Inquisitorius','SEE+Empire','First Order']},
    {name:'Bottom-Right',        align:'ds', topTeams:['SLKR First Order','SEE+Wat','Empire']},
    {name:'Lord Vader',          align:'ds', topTeams:['Inquisitorius'], requiredUnits:['LORDVADER'],
     note:'Lord Vader only; no other units allowed'},
  ], sm:null},
  corellia: { zone:1, minRelic:5, cms:[
    {name:'Mixed Combat',        align:'mx', topTeams:['JTR Resistance','Rey+Finn','Rogue One','Any strong team']},
    {name:'Jabba the Hutt',      align:'mx', topTeams:['Jabba Hutt Crime','Bounty Hunters'], requiredUnits:['JABBATHEHUTT'],
     note:'Jabba the Hutt is required as leader'},
    {name:'Doctor Aphra',        align:'mx', topTeams:['Palpatine Empire','JTR','Jabba'], requiredUnits:['DOCTORAPHRA'],
     note:'Doctor Aphra is required as leader'},
  ], sm:{name:"Qi'ra + Young Han",align:'mx',minRelic:5,requiredUnits:['QIRA','YOUNGHAN'],
    topTeams:["Qi'ra + Young Han Solo"],note:"Qi'ra required as leader; Young Han Solo also required"}},
  coruscant: { zone:1, minRelic:5, cms:[
    {name:'Light Side Combat 1', align:'ls', topTeams:['Bad Batch','JTR+BB8','Mando Marauders']},
    {name:'Light Side Combat 2', align:'ls', topTeams:['Bad Batch','Mando Marauders','Rebel Fighters']},
    {name:'Jedi',                align:'ls', topTeams:['JML+JKL Jedi','Mace Windu Jedi','Padme Jedi']},
    {name:'Mace / Kit',          align:'ls', topTeams:['Mace+Fisto+JMK+KAM+GK','JML Jedi'], requiredUnits:['MACEWINDU','KITFISTO'],
     note:'Mace Windu required as leader; Kit Fisto also required'},
  ], sm:null},
  // ── PHASE 2 ──────────────────────────────────────────────────────────────
  geonosis: { zone:2, minRelic:6, cms:[
    {name:'Left (Reek)',         align:'ds', topTeams:['SEE+Wat+GG+Nute+Jango','Inquisitorius']},
    {name:'Bottom (Acklay)',     align:'ds', topTeams:['Inquisitorius (no GI)','GI lead Inquisitors']},
    {name:'Top (Nexu)',          align:'ds', topTeams:['Lord Vader+Piett+Tarkin+Palp+Thrawn','Tarkin Empire']},
    {name:'Geonosians',          align:'ds', topTeams:['Sith','SEE+Empire','SLKR FO']},
  ], sm:null},
  felucia: { zone:2, minRelic:6, cms:[
    {name:'Mixed Combat',        align:'mx', topTeams:['Any strong mixed R6']},
    {name:'Young Lando',         align:'mx', topTeams:['Bounty Hunters','Hondo+BH','Mandalorian'], requiredUnits:['YOUNGLANDO'],
     note:'Young Lando Calrissian is required'},
    {name:'Jabba the Hutt',      align:'mx', topTeams:['Jabba Hutt Crime','BHs'], requiredUnits:['JABBATHEHUTT'],
     note:'Jabba the Hutt is required as leader'},
    {name:'Hondo',               align:'mx', topTeams:['GAS 501st','Rex Clone Troopers'], requiredUnits:['HONDO'],
     note:'Hondo Ohnaka is required but not forced leader'},
  ], sm:null},
  bracca: { zone:2, minRelic:6, cms:[
    {name:'Left',                align:'ls', topTeams:['JTR+BB8+R2+C3PO+RH Finn','Rey+Resistance']},
    {name:'Jedi',                align:'ls', topTeams:['JKL+JML+GMY+Bastila+Shaak Ti']},
    {name:'Right',               align:'ls', topTeams:['Rey','Jedi','Rebel Fighters']},
  ], sm:{name:'Unlock Zeffo',align:'ls',minRelic:7,
    requiredUnits:['CEREJUNDA'],
    requiredAnyOneOf:[['JEDIKNIGHTCAL','CALKESTIS']],
    topTeams:['Cere Junda + Jedi Knight Cal Kestis or Cal Kestis'],
    note:'Cere Junda must lead; only one Cal is allowed as the other unit'}},
  // ── PHASE 3 ──────────────────────────────────────────────────────────────
  dathomir: { zone:3, minRelic:7, cms:[
    {name:'Left',                align:'ds', topTeams:['Empire (Thrawn/Vader/Piett)']},
    {name:'Right',               align:'ds', topTeams:['Inquisitorius GL lead']},
    {name:'Empire',              align:'ds', topTeams:['SEE','SLKR','LV Empire']},
    {name:'Doctor Aphra',        align:'ds', topTeams:['Sith','Dark Side GL'], requiredUnits:['DOCTORAPHRA'],
     note:'Doctor Aphra is required as leader'},
  ], sm:{name:'Merrin',align:'ds',minRelic:7,requiredUnits:['MERRIN'],topTeams:['Nightsisters'],note:'50 Mk II Guild Event Tokens; Merrin required'}},
  tatooine: { zone:3, minRelic:7, cms:[
    {name:'Mixed Combat',        align:'mx', topTeams:['Any mixed R7','Executor+BH fleet']},
    {name:'Jabba the Hutt',      align:'mx', topTeams:['Jabba Hutt Crime','Jabba solo carry'], requiredUnits:['JABBATHEHUTT'],
     note:'Jabba the Hutt is required as leader'},
    {name:'Fennec Shand',        align:'mx', topTeams:['Fennec+Bounty Hunters','Jabba BH'], requiredUnits:['FENNECSHAND'],
     note:'Fennec Shand is required'},
  ...
  kashyyyk: { zone:3, minRelic:7, cms:[
    ...
    {name:'Bottom-Left (Imp Officer)', align:'ls', topTeams:['Rebel Fighters','Jedi','Bad Batch']},
    {name:'Top-Right (Mara Jade)',     align:'ls', topTeams:['Any LS R7','JML Jedi']},
  ], sm:{name:'Saw Gerrera',align:'ls',minRelic:7,
    requiredUnits:['SAWGERRERA'],
    topTeams:['Saw Gerrera + Rebel Fighters (Cassian, K2SO, Jan Erso, Luthen)'],
    note:'Saw Gerrera is required as leader; reward is 50 Mk II Guild Event Tokens'}},
  zeffo: { zone:3, minRelic:7, cms:[
    {name:'UFU Combat 1',             align:'ls', topTeams:['Rey+RJT+CLS+Cere+Cal Kestis']},
    {name:'Jedi Knight Cal Kestis',   align:'ls', topTeams:['Cere+Cal Kestis Jedi'], requiredUnits:['JEDIKNIGHTCAL'],
     note:'Jedi Knight Cal Kestis is required as leader'},
    {name:'Light Side Combat',        align:'ls', topTeams:['Any strong Light Side R7']},
  ], sm:{name:'Clone Trooper',align:'ls',minRelic:7,
    topTeams:['Clone Troopers'],
    note:'Reward is 50 Mk II Guild Event Tokens'}},
  // ── PHASE 4 ──────────────────────────────────────────────────────────────
  medstation: { zone:4, minRelic:8, cms:[
    {name:'Brain Worms 1',       align:'ds', topTeams:['Empire','Sith','Dark Side GL']},
    {name:'Brain Worms 2',       align:'ds', topTeams:['LV Empire','Inquisitorius']},
    {name:'Brain Worms 3',       align:'ds', topTeams:['SEE','SLKR','Darth Vader']},
    {name:'Droids CM (Left)',    align:'ds', topTeams:['Any Dark Side R8']},
  ], sm:{name:'Inquisitors',align:'ds',minRelic:8,requiredUnits:['THIRDSISTER'],topTeams:['Third Sister Inquisitorius'],note:'Third Sister is required as leader; Great Mothers are not allowed'}},
  kessel: { zone:4, minRelic:8, cms:[
    {name:'Top-Left',            align:'mx', topTeams:['Jabba','BHs','Mixed R8']},
    {name:'Top-Right',           align:'mx', topTeams:['Any mixed R8']},
    {name:'Jabba the Hutt',      align:'mx', topTeams:['Jabba Hutt Crime'], requiredUnits:['JABBATHEHUTT'], note:'Jabba the Hutt is required as leader'},
  ], sm:{name:'Qi\'ra + L3-37',align:'mx',minRelic:8,
    requiredUnits:['QIRA','L3_37'],
    topTeams:['Baylan Skoll+Shin Hati+Marrok+Qi\'ra+L3-37'],
    note:'Qi\'ra and L3-37 are required; reward is 20 Mk III Guild Event Tokens'}},
  lothal: { zone:4, minRelic:8, cms:[
  ...
  mandalore: { zone:4, minRelic:8, cms:[
    {name:'Dark Trooper Moff Gideon', align:'mx', topTeams:['Imperial Remnant at R8 (Moff Gideon lead)'], requiredUnits:['MOFFGIDEONS3'],note:'Dark Trooper Moff Gideon is required as leader'},
    {name:'Mixed Combat',            align:'mx', topTeams:['Imperial Remnant R8','Empire','Any mixed R8']},
    {name:"Bo-Katan (Mand'alor)",    align:'mx', topTeams:["Bo-Katan (Mand'alor) Mandalorians"], requiredUnits:['MANDALORBOKATAN'], note:"Bo-Katan (Mand'alor) is required as leader; all units must be Mandalorian and R9+"},
  ], sm:null},
  // ── PHASE 5 ──────────────────────────────────────────────────────────────
  malachor: { zone:5, minRelic:7, cms:[
    {name:'Bottom-Left',align:'ds',topTeams:['Any DS R8']},
    {name:'Top-Left',align:'ds',topTeams:['Any DS R8']},
    {name:'Top-Right',align:'ds',topTeams:['Any DS R8']},
    {name:'Eighth / Fifth / Seventh Sister',align:'ds',topTeams:['Grand Inquisitor Inquisitorius'],requiredUnits:['EIGHTHBROTHER','FIFTHBROTHER','SEVENTHSISTER'],note:'Eighth Brother, Fifth Brother, and Seventh Sister are required'},
  ], sm:null},
  vandor: { zone:5, minRelic:7, cms:[
    {name:'Bottom',align:'mx',topTeams:['Any mixed R8']},
    {name:'Top',align:'mx',topTeams:['Any mixed R8']},
    {name:'Jabba the Hutt',align:'mx',topTeams:['Jabba Hutt Crime'],requiredUnits:['JABBATHEHUTT'],note:'Jabba the Hutt is required as leader'},
  ], sm:{name:'Young Han + Vandor Chewie',align:'mx',minRelic:8,requiredUnits:['YOUNGHAN','YOUNGCHEWBACCA'],topTeams:['Young Han Solo + Vandor Chewbacca'],note:'Rewards 20 Mk III Guild Event Tokens'}},
  kafrene: { zone:5, minRelic:8, cms:[
    {name:'Top',align:'ls',topTeams:['Any LS R8']},
    {name:'Middle',align:'ls',topTeams:['Any LS R8']},
    {name:'Bottom',align:'ls',topTeams:['Any LS R8']},
    {name:'Cassian Andor + K-2SO',align:'ls',topTeams:['Rogue One'],requiredUnits:['CASSIANANDOR','K2SO'],note:'Cassian Andor and K-2SO are required'},
  ], sm:null},
  // ── PHASE 6 ──────────────────────────────────────────────────────────────
  deathstar: { zone:6, minRelic:9, cms:[
    {name:'Bottom-Left',         align:'ds', topTeams:['Any DS R9']},
    {name:'Bottom-Right',        align:'ds', topTeams:['Any DS R9']},
    {name:'Darth Vader',         align:'ds', topTeams:['Darth Vader solo R9+'], requiredUnits:['VADER'], note:'Darth Vader is required as leader and is the only allowed unit'},
    {name:'Iden Versio',         align:'ds', topTeams:['Iden Versio Dark Side squad'], requiredUnits:['IDENVERSIOEMPIRE'], note:'Iden Versio is required'},
  ], sm:null},
  hoth: { zone:6, minRelic:9, cms:[
    {name:'Bottom',align:'mx',topTeams:['Any mixed R9']},
    {name:'Top-Middle',align:'mx',topTeams:['Any mixed R9']},
    {name:'Jabba the Hutt',align:'mx',topTeams:['Jabba mixed squad'],requiredUnits:['JABBATHEHUTT'],note:'Jabba the Hutt is required as leader'},
  ], sm:{name:'Doctor Aphra / BT-1 / 0-0-0',align:'mx',minRelic:9,requiredUnits:['DOCTORAPHRA','BT1','TRIPLEZERO'],topTeams:['Doctor Aphra droids'],note:'Doctor Aphra is required as leader; BT-1 and 0-0-0 are also required'}},
  scarif: { zone:6, minRelic:9, cms:[
    {name:'Bottom-Left',align:'ls',topTeams:['Rogue One R9','Any LS R9']},
    {name:'Bottom-Right',align:'ls',topTeams:['Any LS R9']},
    {name:'Baze / Chirrut / SRP',align:'ls',topTeams:['Rogue One R9'],requiredUnits:['BAZEMALBUS','CHIRRUTIMWE','SCARIFREBEL']},
    {name:'Cassian / Pao / K-2SO',align:'ls',topTeams:['Rogue One R9'],requiredUnits:['CASSIANANDOR','PAO','K2SO']},
  ], sm:null},
};
...
function assessMission(roster, pid, missionType){
  ...
  const requiredAnyOneOf = Array.isArray(mission.requiredAnyOneOf) ? mission.requiredAnyOneOf : [];
  ...
  const missingEither = requiredAnyOneOf.filter(group=>{
    const options = Array.isArray(group) ? group : [group];
    return !options.some(defId=>{
      const u = roster.find(r=>unitMatchesDefId(r, defId));
      return !!u && u.rarity>=7 && u.relic>=minRelic;
    });
  });
  if(missingReq.length>0 || missingEither.length>0){
    const names = missingReq.map(d=>KEY_MISSION_UNITS[d]||d)
      .concat(missingEither.map(group=>{
        const options = (Array.isArray(group) ? group : [group]).map(d=>KEY_MISSION_UNITS[d]||d);
...
const PLANET_MISSIONS = {
  mustafar:   {phase:1,align:'ds',relic:5,name:'Mustafar', missions:[
    {id:'nute',  label:'Bottom-Left',  type:'cm',    pointsSingle:100000, points:200000, unitsText:'Dark Side or Neutral'},
    {id:'wat',   label:'Top',          type:'cm',    pointsSingle:100000, points:200000, unitsText:'Dark Side or Neutral'},
    {id:'geo',   label:'Bottom-Right', type:'cm',    pointsSingle:100000, points:200000, unitsText:'Dark Side or Neutral'},
    {id:'lv',    label:'Lord Vader',   type:'cm',    pointsSingle:100000, points:200000, unitsText:'Lord Vader only', req:['LORDVADER']},
    {id:'fleet', label:'Fleet',        type:'fleet', pointsSingle:400000, points:400000, unitsText:'7-star ships; Scythe required in the starting lineup', req:['SCYTHE']},
  ]},
  corellia:   {phase:1,align:'mx',relic:5,name:'Corellia', missions:[
    {id:'combat', label:'Mixed Combat',            type:'cm',    pointsSingle:100000, points:200000, unitsText:'Dark Side or Light Side or Neutral'},
    {id:'jabba',  label:'Jabba the Hutt',          type:'cm',    pointsSingle:100000, points:200000, unitsText:'Dark Side or Light Side or Neutral; Jabba the Hutt required as leader', req:['JABBATHEHUTT']},
    {id:'aphra',  label:'Doctor Aphra',            type:'cm',    pointsSingle:100000, points:200000, unitsText:'Dark Side or Light Side or Neutral; Doctor Aphra required as leader', req:['DOCTORAPHRA']},
    {id:'fleet',  label:'Fleet',                   type:'fleet', pointsSingle:400000, points:400000, unitsText:"7-star ships; Lando's Millennium Falcon required in the starting lineup", req:['MILLENNIUMFALCONPRISTINE']},
    {id:'sm',     label:"Qi'ra + Young Han",       type:'sm',    req:['QIRA','YOUNGHAN'], unitsText:"Qi'ra required as leader; Young Han Solo also required", rewardText:'15 Mk III Guild Tokens'},
  ]},
  coruscant:  {phase:1,align:'ls',relic:5,name:'Coruscant', missions:[
    {id:'combat',  label:'Light Side Combat 1', type:'cm',    pointsSingle:100000, points:200000, unitsText:'Light Side or Neutral'},
    {id:'combat2', label:'Light Side Combat 2', type:'cm',    pointsSingle:100000, points:200000, unitsText:'Light Side or Neutral'},
    {id:'jedi',    label:'Jedi',                type:'cm',    pointsSingle:100000, points:200000, unitsText:'Jedi'},
    {id:'mace',    label:'Mace / Kit',          type:'cm',    pointsSingle:100000, points:200000, unitsText:'Jedi; Mace Windu required as leader, Kit Fisto also required', req:['MACEWINDU','KITFISTO']},
    {id:'fleet',   label:'Fleet',               type:'fleet', pointsSingle:400000, points:400000, unitsText:'7-star ships; Outrider required in the starting lineup', req:['OUTRIDER']},
  ]},
  geonosis:   {phase:2,align:'ds',relic:6,name:'Geonosis', missions:[
    {id:'reek',   label:'Left (Reek)',     type:'cm',    pointsSingle:125000, points:250000, unitsText:'Dark Side or Neutral'},
    {id:'acklay', label:'Bottom (Acklay)', type:'cm',    pointsSingle:125000, points:250000, unitsText:'Dark Side or Neutral'},
    {id:'nexu',   label:'Top (Nexu)',      type:'cm',    pointsSingle:125000, points:250000, unitsText:'Dark Side or Neutral'},
    {id:'combat', label:'Geonosians',      type:'cm',    pointsSingle:125000, points:250000, unitsText:'Geonosian'},
    {id:'fleet',  label:'Fleet',           type:'fleet', pointsSingle:500000, points:500000, unitsText:'7-star ships'},
  ]},
  felucia:    {phase:2,align:'mx',relic:6,name:'Felucia', missions:[
    {id:'combat', label:'Mixed Combat',      type:'cm',    pointsSingle:125000, points:250000, unitsText:'Dark Side or Light Side or Neutral'},
    {id:'bh',     label:'Young Lando',       type:'cm',    pointsSingle:125000, points:250000, unitsText:'Dark Side or Light Side or Neutral; Young Lando Calrissian required'},
    {id:'jabba',  label:'Jabba the Hutt',    type:'cm',    pointsSingle:125000, points:250000, unitsText:'Dark Side or Light Side or Neutral; Jabba the Hutt required as leader', req:['JABBATHEHUTT']},
    {id:'hondo',  label:'Hondo',             type:'cm',    pointsSingle:125000, points:250000, unitsText:'Dark Side or Light Side or Neutral; Hondo Ohnaka required', req:['HONDO']},
    {id:'fleet',  label:'Fleet',             type:'fleet', pointsSingle:500000, points:500000, unitsText:'7-star ships'},
  ]},
  bracca:     {phase:2,align:'ls',relic:6,name:'Bracca', missions:[
    {id:'jtr',   label:'Left',                  type:'cm',    pointsSingle:125000, points:250000, unitsText:'Light Side or Neutral'},
    {id:'jedi',  label:'Jedi',                  type:'cm',    pointsSingle:125000, points:250000, unitsText:'Jedi'},
    {id:'open',  label:'Right',                 type:'cm',    pointsSingle:125000, points:250000, unitsText:'Light Side or Neutral'},
    {id:'fleet', label:'Fleet',                 type:'fleet', pointsSingle:500000, points:500000, unitsText:'7-star ships'},
    {id:'sm',    label:'Unlock Zeffo',          type:'sm',    relic:7, req:['CEREJUNDA'], reqAnyOneOf:[['JEDIKNIGHTCAL','CALKESTIS']], unitsText:'Cere Junda required as leader; Jedi Knight Cal Kestis or Cal Kestis required as the only other unit', rewardText:'15 Mk III Guild Tokens', unlocks:'zeffo'},
  ]},
  dathomir:   {phase:3,align:'ds',relic:7,name:'Dathomir', missions:[
    {id:'cm1', label:'Left',              type:'cm', pointsSingle:162500, points:341250, unitsText:'Dark Side or Neutral'},
    {id:'cm2', label:'Right',             type:'cm', pointsSingle:162500, points:341250, unitsText:'Dark Side or Neutral'},
    {id:'cm3', label:'Empire',            type:'cm', pointsSingle:162500, points:341250, unitsText:'Empire'},
    {id:'cm4', label:'Doctor Aphra',      type:'cm', pointsSingle:162500, points:341250, unitsText:'Dark Side or Neutral; Doctor Aphra required as leader', req:['DOCTORAPHRA']},
    {id:'sm',  label:'Merrin',             type:'sm', req:['MERRIN'], unitsText:'Nightsister; Merrin required', rewardText:'50 Mk II Guild Event Tokens'},
  ]},
  tatooine:   {phase:3,align:'mx',relic:7,name:'Tatooine', missions:[
    {id:'combat', label:'Mixed Combat',           type:'cm',    pointsSingle:162500, points:341250, unitsText:'Dark Side or Light Side or Neutral'},
    {id:'jabba',  label:'Jabba the Hutt',         type:'cm',    pointsSingle:162500, points:341250, unitsText:'Dark Side or Light Side or Neutral; Jabba the Hutt required as leader', req:['JABBATHEHUTT']},
    {id:'fennec', label:'Fennec Shand',           type:'cm',    pointsSingle:162500, points:341250, unitsText:'Dark Side or Light Side or Neutral; Fennec Shand required', req:['FENNECSHAND']},
    {id:'fleet',  label:'Fleet',                  type:'fleet', pointsSingle:682500, points:682500, unitsText:'7-star ships; Executor required as the capital ship leader', req:['EXECUTOR']},
    {id:'rey',    label:'Reva Unlock',            type:'sm',    req:['GRANDINQUISITOR'], unitsText:'Inquisitorius; Grand Inquisitor required as leader', rewardText:'Third Sister shards'},
    {id:'sm',     label:'Unlock Mandalore',       type:'sm',    req:['MANDALORBOKATAN','THEMANDALORIANBESKARARMOR'], unitsText:"Bo-Katan (Mand'alor) required as leader; The Mandalorian (Beskar Armor) also required", rewardText:'15 Mk III Guild Tokens', unlocks:'mandalore'},
  ]},
  kashyyyk:   {phase:3,align:'ls',relic:7,name:'Kashyyyk', missions:[
    ...
    {id:'cm2',     label:'Bottom-Left (Imp Officer)',  type:'cm',    pointsSingle:162500, points:341250, unitsText:'Light Side or Neutral'},
    {id:'cm3',     label:'Top-Right (Mara Jade)',      type:'cm',    pointsSingle:162500, points:341250, unitsText:'Light Side or Neutral'},
    {id:'fleet',   label:'Fleet',                       type:'fleet', pointsSingle:682500, points:682500, unitsText:'7-star ships; Profundity required as the capital ship leader', req:['PROFUNDITY']},
    {id:'sm',      label:'Saw Gerrera',                 type:'sm',    req:['SAWGERRERA'], unitsText:'Rebel Fighter; Saw Gerrera required as leader', rewardText:'50 Mk II Guild Event Tokens'},
  ]},
  zeffo:      {phase:3,align:'ls',relic:7,name:'Zeffo (Bonus)', missions:[
    ...
    {id:'cal',     label:'Jedi Knight Cal Kestis',   type:'cm', pointsSingle:487500, points:1023750, unitsText:'Light Side or Neutral; Jedi Knight Cal Kestis required as leader', req:['JEDIKNIGHTCAL']},
    {id:'ls',      label:'Light Side Combat',        type:'cm', pointsSingle:162500, points:341250, unitsText:'Light Side or Neutral'},
    {id:'fleet',   label:'Fleet',                    type:'fleet', pointsSingle:682500, points:682500, unitsText:'7-star ships; Negotiator required as the capital ship leader', req:['NEGOTIATOR']},
    {id:'sm',      label:'Clone Trooper',            type:'sm', unitsText:'Clone Trooper', rewardText:'50 Mk II Guild Event Tokens'},
  ]},
  medstation: {phase:4,align:'ds',relic:8,name:'Med Station', missions:[
    {id:'cm1', label:'Brain Worms 1',                type:'cm', pointsSingle:219375, points:493594, unitsText:'Dark Side or Neutral'},
    {id:'cm2', label:'Brain Worms 2',                type:'cm', pointsSingle:219375, points:493594, unitsText:'Dark Side or Neutral'},
    {id:'cm3', label:'Brain Worms 3',                type:'cm', pointsSingle:219375, points:493594, unitsText:'Dark Side or Neutral'},
    {id:'cm4', label:'Droids CM (Left)',             type:'cm', pointsSingle:219375, points:493594, unitsText:'Dark Side or Neutral'},
    {id:'sm',  label:'Inquisitors',                  type:'sm', req:['THIRDSISTER'], unitsText:'Inquisitorius; Third Sister required as leader. Great Mothers are not allowed', rewardText:'Special mission reward'},
  ]},
  kessel:     {phase:4,align:'mx',relic:8,name:'Kessel', missions:[
    {id:'cm1',   label:'Top-Left',                   type:'cm',    pointsSingle:219375, points:493594, unitsText:'Dark Side or Light Side or Neutral'},
    {id:'cm2',   label:'Top-Right',                  type:'cm',    pointsSingle:219375, points:493594, unitsText:'Dark Side or Light Side or Neutral'},
    {id:'cm3',   label:'Jabba the Hutt',             type:'cm',    pointsSingle:219375, points:493594, unitsText:'Dark Side or Light Side or Neutral; Jabba the Hutt required as leader', req:['JABBATHEHUTT']},
    {id:'fleet', label:'Fleet',                      type:'fleet', pointsSingle:987188, points:987188, unitsText:'7-star ships; Ghost required in the starting lineup', req:['GHOST']},
    {id:'sm',    label:"Qi'ra + L3-37",              type:'sm',    req:['QIRA','L3_37'], unitsText:"Qi'ra and L3-37 required", rewardText:'20 Mk III Guild Event Tokens'},
  ]},
  lothal:     {phase:4,align:'ls',relic:8,name:'Lothal', missions:[
    ...
    {id:'cm3',   label:'Light Side Combat',          type:'cm',    pointsSingle:219375, points:493594, unitsText:'Light Side or Neutral'},
    {id:'fleet', label:'Fleet',                      type:'fleet', pointsSingle:987188, points:987188, unitsText:'7-star ships'},
  ]},
  mandalore:  {phase:4,align:'ds',relic:8,name:'Mandalore (Bonus)', missions:[
    {id:'dtmg',  label:'Dark Trooper Moff Gideon',   type:'cm',    pointsSingle:219375, points:493594, unitsText:'Dark Side or Light Side or Neutral; Dark Trooper Moff Gideon required as leader', req:['MOFFGIDEONS3']},
    {id:'cm2',   label:'Mixed Combat',               type:'cm',    pointsSingle:219375, points:493594, unitsText:'Dark Side or Light Side or Neutral'},
    {id:'cm4',   label:"Bo-Katan (Mand'alor)",       type:'cm',    relic:9, pointsSingle:658125, points:1480782, unitsText:"Mandalorian; Bo-Katan (Mand'alor) required as leader; all units R9+", req:['MANDALORBOKATAN']},
    {id:'fleet', label:'Fleet',                      type:'fleet', pointsSingle:987188, points:987188, unitsText:'7-star ships; Gauntlet Starfighter required in the starting lineup', req:['GAUNTLETSTARFIGHTER']},
  ]},
  malachor:   {phase:5,align:'ds',relic:8,name:'Malachor', missions:[
    {id:'cm1', label:'Bottom-Left',                  type:'cm', pointsSingle:307125, points:721744, unitsText:'Dark Side or Neutral'},
    {id:'cm2', label:'Top-Left',                     type:'cm', pointsSingle:307125, points:721744, unitsText:'Dark Side or Neutral'},
    {id:'cm3', label:'Top-Right',                    type:'cm', pointsSingle:307125, points:721744, unitsText:'Dark Side or Neutral'},
    {id:'cm4', label:'Eighth / Fifth / Seventh Sister', type:'cm', pointsSingle:307125, points:721744, unitsText:'Dark Side or Neutral; Eighth Brother, Fifth Brother, and Seventh Sister required', req:['EIGHTHBROTHER','FIFTHBROTHER','SEVENTHSISTER']},
  ]},
  vandor:     {phase:5,align:'mx',relic:8,name:'Vandor', missions:[
    {id:'cm1',   label:'Bottom',                     type:'cm',    pointsSingle:307125, points:721744, unitsText:'Dark Side or Light Side or Neutral'},
    {id:'cm2',   label:'Top',                        type:'cm',    pointsSingle:307125, points:721744, unitsText:'Dark Side or Light Side or Neutral'},
    {id:'cm3',   label:'Jabba the Hutt',             type:'cm',    pointsSingle:307125, points:721744, unitsText:'Dark Side or Light Side or Neutral; Jabba the Hutt required as leader', req:['JABBATHEHUTT']},
    {id:'fleet', label:'Fleet',                      type:'fleet', pointsSingle:1443488, points:1443488, unitsText:'7-star ships'},
    {id:'sm',    label:'Young Han + Vandor Chewie',  type:'sm',    req:['YOUNGHAN','YOUNGCHEWBACCA'], unitsText:'Young Han Solo and Vandor Chewbacca required', rewardText:'20 Mk III Guild Event Tokens'},
  ]},
  kafrene:    {phase:5,align:'ls',relic:8,name:'Kafrene', missions:[
    {id:'cm1',   label:'Top',                        type:'cm',    pointsSingle:307125, points:721744, unitsText:'Light Side or Neutral'},
    {id:'cm2',   label:'Middle',                     type:'cm',    pointsSingle:307125, points:721744, unitsText:'Light Side or Neutral'},
    {id:'cm3',   label:'Bottom',                     type:'cm',    pointsSingle:307125, points:721744, unitsText:'Light Side or Neutral'},
    {id:'cm4',   label:'Cassian Andor + K-2SO',      type:'cm',    pointsSingle:307125, points:721744, unitsText:'Light Side or Neutral; Cassian Andor and K-2SO required', req:['CASSIANANDOR','K2SO']},
    {id:'fleet', label:'Fleet',                      type:'fleet', pointsSingle:1443488, points:1443488, unitsText:'7-star ships'},
  ]},
  deathstar:  {phase:6,align:'ds',relic:9,name:'Death Star', missions:[
    {id:'cm3',   label:'Bottom-Left',                type:'cm',    pointsSingle:460668, points:1151719, unitsText:'Dark Side or Neutral'},
    {id:'cm4',   label:'Bottom-Right',               type:'cm',    pointsSingle:460668, points:1151719, unitsText:'Dark Side or Neutral'},
    {id:'dv',    label:'Darth Vader',                type:'cm',    pointsSingle:460668, points:1151719, unitsText:'Darth Vader only; Darth Vader required as leader', req:['VADER']},
    {id:'iden',  label:'Iden Versio',                type:'cm',    pointsSingle:460668, points:1151719, unitsText:'Dark Side or Neutral; Iden Versio required', req:['IDENVERSIOEMPIRE']},
    {id:'fleet', label:'Fleet',                      type:'fleet', pointsSingle:2303438, points:2303438, unitsText:'7-star ships; Imperial TIE Fighter required in the starting lineup', req:['TIEFIGHTERIMPERIAL']},
  ]},
  hoth:       {phase:6,align:'mx',relic:9,name:'Hoth', missions:[
    {id:'cm1',   label:'Bottom',                     type:'cm', pointsSingle:460668, points:1151719, unitsText:'Dark Side or Light Side or Neutral'},
    {id:'cm2',   label:'Top-Middle',                 type:'cm', pointsSingle:460668, points:1151719, unitsText:'Dark Side or Light Side or Neutral'},
    {id:'cm3',   label:'Jabba the Hutt',             type:'cm', pointsSingle:460668, points:1151719, unitsText:'Dark Side or Light Side or Neutral; Jabba the Hutt required as leader', req:['JABBATHEHUTT']},
    {id:'sm',    label:'Doctor Aphra / BT-1 / 0-0-0',type:'sm', req:['DOCTORAPHRA','BT1','TRIPLEZERO'], unitsText:'Dark Side or Light Side or Neutral; Doctor Aphra required as leader, BT-1 and 0-0-0 also required', rewardText:'Special mission reward'},
    {id:'fleet', label:'Fleet',                      type:'fleet', pointsSingle:2303438, points:2303438, unitsText:'7-star ships'},
  ]},
  scarif:     {phase:6,align:'ls',relic:9,name:'Scarif', missions:[
    {id:'cm1',   label:'Bottom-Left',                type:'cm',    pointsSingle:460668, points:1151719, unitsText:'Light Side or Neutral'},
    {id:'cm2',   label:'Bottom-Right',               type:'cm',    pointsSingle:460668, points:1151719, unitsText:'Light Side or Neutral'},
    {id:'cm3',   label:'Baze / Chirrut / SRP',       type:'cm',    pointsSingle:460668, points:1151719, unitsText:'Light Side or Neutral; Baze Malbus, Chirrut Imwe, and Scarif Rebel Pathfinder required', req:['BAZEMALBUS','CHIRRUTIMWE','SCARIFREBEL']},
    {id:'cm4',   label:'Cassian / Pao / K-2SO',      type:'cm',    pointsSingle:460668, points:1151719, unitsText:'Light Side or Neutral; Cassian Andor, Pao, and K-2SO required', req:['CASSIANANDOR','PAO','K2SO']},
    {id:'fleet', label:'Fleet',                      type:'fleet', pointsSingle:2303438, points:2303438, unitsText:'7-star ships; Profundity required as the capital ship leader', req:['PROFUNDITY']},
  ]},
};
